...
INSERT INTO account (first_name, last_name, full_name, email, passcode, is_admin)
VALUES ('Mark', 'Redekopp', 'Mark Redekopp', 'mark@usc.edu', 'c4ca4238a0b923820dcc509a6f75849b', 1);

INSERT INTO account (first_name, last_name, full_name, email, passcode, is_admin)
VALUES ('Admin', 'Pic', 'Admin Pic', 'admin@usc.edu', 'c4ca4238a0b923820dcc509a6f75849b', 1);
...
VALUES (3, 4, '03/11/2021 10:00');

INSERT INTO visit_history (account_id, place_id, enter_time)
VALUES (1, 4, '03/11/2021 10:00');
